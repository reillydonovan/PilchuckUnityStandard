...
public class SphereHarmonicManager : MonoBehaviour
{
    public enum MobiusState { ambientState, activeState };
    public MobiusState CurrentState = MobiusState.ambientState;
    ...
    void Update()
    {
        switch (CurrentState)
        {
            case MobiusState.ambientState:
                {

                }
                break;

            case MobiusState.activeState:
                {
                    MobiusActiveState();
                }
                break;
